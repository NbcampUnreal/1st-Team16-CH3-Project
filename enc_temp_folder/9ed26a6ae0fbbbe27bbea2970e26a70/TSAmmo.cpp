    ...
    bool bFromSweep, const FHitResult& SweepResult)
{
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("OnOverlap(): InstigatorController가 NULL입니다! 데미지를 적용할 수 없습니다."));
        return;
    }

    float AppliedDamage = Damage;

    UGameplayStatics::ApplyDamage(OtherActor, AppliedDamage, InstigatorController, this, UDamageType::StaticClass());
